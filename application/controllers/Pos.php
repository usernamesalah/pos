        ...
        for ($i = 0; $i < count($orderItemData); ++$i) {
            ...
            $mesg .= '
				<tr>
	                ...
	                <td style="text-align:center; width:50px;" valign="top">'.number_format($price, 0,'.','.').'</td>
	                <td style="text-align:right; width:70px;" valign="top">'.number_format($each_row_price, 0,'.','.').'</td>
				</tr>';
    ...
    <table class="totals" cellspacing="0" border="0" style="margin-bottom:5px; border-top: 1px solid #000;" width="100%">
    	<tbody>
			<tr>
				...
				<td style="text-align:right;font-weight:bold;" width="25%">'.number_format($total_item_amt, 0,'.','.').'</td>
			</tr>';
        ...
        if ($dis_amt > 0) {
            ...
            $mesg .= '
						...
						<td style="text-align:right;font-weight:bold;">-'.number_format($dis_amt, 0,'.','.').'</td>
					</tr>';
        }
        ...
        $mesg .= '
			...
			<tr>
				...
				<td style="text-align:right;font-weight:bold;">'.number_format($tax_amt, 0,'.','.').'</td>
			</tr>
			<tr>
				<td colspan="2" style="text-align:left; font-weight:bold; border-top:1px solid #000; padding-top:5px;">Grand Total</td>
				<td colspan="2" style="border-top:1px solid #000; padding-top:5px; text-align:right; font-weight:bold;">'.number_format($grandTotal, 0,'.','.').'</td>
    		</tr>
    		
			<tr>    
				<td colspan="2" style="text-align:left; font-weight:bold; padding-top:5px;">Paid</td>
				<td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">'.number_format($paid_amt, 0,'.','.').'</td>
    		</tr>';
        ...
        if ($return_change > 0) {
            $mesg .= '
				    	<tr>
							...
							<td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">'.number_format($return_change, 0,'.','.').'</td>
			    		</tr>
					';
        }
        ...
        if ($unpaid_amt < 0) {
            $mesg .= '
				    	<tr>
							...
							<td colspan="2" style="padding-top:5px; text-align:right; font-weight:bold;">'.number_format($unpaid_amt, 0,'.','.').'</td>
			    		</tr>
					';
        }
