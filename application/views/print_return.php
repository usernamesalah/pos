    ...
    <table class="totals" cellspacing="0" border="0" style="margin-bottom:5px; border-top: 1px solid #000;">
    	<tbody>
			...
			<tr>
				...
				<td style="text-align:right;font-weight:bold;"><?php echo number_format($ret_subTotal, 0, '.','.'); ?></td>
			</tr>
			<tr>
				...
				<td style="text-align:right;font-weight:bold;"><?php echo number_format($ret_taxTotal, 0, '.','.'); ?></td>
			</tr>
			<tr>
				...
				<td colspan="2" style="border-top:1px solid #000; padding-top:5px; text-align:right; font-weight:bold;"><?php echo number_format($ret_grandTotal, 0, '.','.'); ?></td>
    		</tr>
