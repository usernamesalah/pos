	...
	<form action="<?=base_url()?>products/updateProduct" method="post" enctype="multipart/form-data">				
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" name="purchase" class="form-control" maxlength="250" autofocus required autocomplete="off" value="<?php echo number_format($cost, 0,'',''); ?>" />
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label><?php echo $lang_retail_price; ?> (<?php echo $lang_price; ?>) <span style="color: #F00">*</span></label>
								<input type="text" name="retail" class="form-control" maxlength="250" required autocomplete="off" value="<?php echo number_format($price, 0,'',''); ?>" />
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-3"><b style="color: #39796b"><?php echo $lang_outlets; ?></b></div>
						<div class="col-md-9"><b style="color: #39796b"><?php echo $lang_inventory_count; ?></b></div>
					</div>
					<?php
                        if ($user_role == 1) {
