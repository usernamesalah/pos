...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<h1 class="page-header" style="margin-top: 0px; padding-bottom: 4px; font-size: 30px; margin: 0px 0 11px; color: #39796b;">
						<?php echo $lang_inventory_by_outlet; ?>
					</h1>
					
					<div class="row" style="padding-top: 10px; padding-bottom: 10px;">
						<div class="col-md-3"><b style="color: #39796b; letter-spacing: 0.2px; font-size: 17px;"><?php echo $lang_outlets; ?></b></div>
						<div class="col-md-9"><b style="color: #39796b; letter-spacing: 0.2px; font-size: 17px;"><?php echo $lang_current_inventory_qty; ?></b></div>
					</div>
					<?php
	...
	<h1 class="page-header" style="margin-top: 0px; padding-bottom: 4px; font-size: 30px; margin: 0px 0 11px; color: #39796b; text-align: center;">
	...
	<div class="row" style="padding-top: 10px; padding-bottom: 10px; border-bottom: 1px solid #eee;">
		<div class="col-md-6"><b style="color: #39796b; letter-spacing: 0.2px; font-size: 17px;"><?php echo $lang_outlets; ?></b></div>
		<div class="col-md-6"><b style="color: #39796b; letter-spacing: 0.2px; font-size: 17px;"><?php echo $lang_quantity; ?></b></div>
	</div>
