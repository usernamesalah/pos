						...
						<div class="col-md-12">
							<div class="panel panel-success">
								<div class="panel-heading" style="font-size: 20px; height: 50px; line-height: 27px;">
									<i class="icono-checkCircle" style="color: #38786a; font-size: 11px;"></i> <?php echo $flash_desc; ?>
								</div>
							</div>
						</div>
					</div>
...
*/
								...
								document.getElementById("display_tax_amt").innerHTML 		= total_tax_amt.toFixed();
								document.getElementById("tax_amt").value 					= total_tax_amt.toFixed();
								
								document.getElementById("total_price").innerHTML 			= total_item_price.toFixed();
								...
								document.getElementById("subTotal").value 					= total_item_price.toFixed();
...
<div style="overflow: scroll; height: 330px; width: 100%;">
            ...
            if (count($susData) == 1) {
                ...
                for ($si = 0; $si < count($susItemData); ++$si) {
					...
					<div class="row" id="item_row_<?php echo $sus_row_count; ?>" style="margin: 0px; border-bottom: 1px solid #dddddd; padding-top: 5px; padding-bottom: 5px;">
						<div class="col-md-4" style="background-color: #38786a; color: #FFF;"><?php echo $pcode_name; ?><br />[<?php echo $sus_pcode; ?>]</div>
						<div class="col-md-4">
							<div class="row">
	...
	<div id="log"></div>
							...
							<div class="row" style="padding-top: 0px; padding-bottom: 0px; margin: 0px; margin-top: 0px;">
											...
											<table border="0" style="border-collapse: collapse;" width="100%" height="auto">
												<tr>
													...
													<td width="30%" height="25px" align="right">
														<?php echo $lang_tax; ?> (<?php echo number_format($tax, 0,'.','.'); ?>%) :
													</td>
							...
							<div class="row">
								...
								<div class="row">
									...
									<div class="col-md-4" style="margin-top: 8px;">
										<a class="btn btn-primary" href="#timepicker4Modal" data-toggle="modal" style="background-color: #38786a; float: right; font-weight: bold; color: #FFF; border: 0px; padding-top: 10px; padding-bottom: 10px; width: 100%;">
                                    ...
                                    ?>	
										...
										<?php
                                            ...
                                            for ($ap = 0; $ap < count($allProdData); ++$ap) {
												...
												<button type="button" id="txtMessage_<?php echo $pp; ?>" value="<?php echo $pcode; ?>" style="margin-top: 10px; margin-left: 19px; border-radius: 5px; padding: 20px 10px 20px 10px; background-color: #38786a; border: 0px; color: #FFF; font-family: Arial, Helvetica, sans-serif; font-size: 13px; width: 120px;">
												<?php
		...
		$('#totalSales').on('shown.bs.modal', function () {	
			...
			var loadTodaySales = $.ajax({
						...
						success	: function(data) {
							...
							document.getElementById("todayMaster").innerHTML	 	= totalMaster.toFixed();
							document.getElementById("todayCheque").innerHTML	 	= totalCheque.toFixed();
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style="overflow: visible; background-color: #FFF; border-radius: 12px;">
					...
					<div class="row">
						<div class="col-md-12" style="text-align: center; font-size: 25px; padding-top: 20px; padding-bottom: 20px; color: #38786a;">
	        ...
	        if(card_numb.length == 0) {
				...
				document.getElementById("submit_btn").style.display = "none";
					...
					<div class="row" style="padding-top: 10px; padding-bottom: 10px;">
						...
						<div class="col-md-6">
							<input type="text" name="paid" id="paid" class="form-control" placeholder="0" style="border: 1px solid #3a3a3a; color: #010101;" <?php if ($keyboard == '1') {
...
<script>
		...
		if(ele == 0){
			...
			if(ele.indexOf("%") >= 0){
				...
				if(ele_amt < final_total_payable){
					...
					document.getElementById("total_price").innerHTML 			= amt.toFixed();
					document.getElementById("total_payable").innerHTML 			= grandTotal;
					
					document.getElementById("final_total_payable").value 		= grandTotal;
					document.getElementById("final_payable_amt").innerHTML 		= grandTotal;
					
					document.getElementById("subTotal").value 					= amt.toFixed();
				} else {
	...
	function calculatePaidAmt(ele){	
		...
		document.getElementById("returned_change").value 	= change_amt.toFixed();
		document.getElementById("return_change").innerHTML 	= change_amt.toFixed();
