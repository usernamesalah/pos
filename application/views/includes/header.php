...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?=base_url()?>assets/css/icono.min.css">

		<!--Material Icon-->
		<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/css/material-icon/icon.css">
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="<?=base_url()?>auth/logout"><i class="icono-power" style="color: #38786a;"></i> <?php echo $lang_logout; ?></a></li>
						</ul>
					</li>
				</ul>
				<ul class="user-menu">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<?php
                                ...
                                if ($temp_site_lang == 'english') {
                                    echo '<img src="'.base_url().'assets/img/english_flag.png" style="border-radius:4px"/>';
                                } elseif ($temp_site_lang == 'indonesia') {
                                    echo '<img src="'.base_url().'assets/img/indonesia_flag.png" style="border-radius:4px"/>';
                                } else {
                                    echo '<img src="'.base_url().'assets/img/english_flag.png" style="border-radius:4px"/>';
                                }
                            ?>
						...
						<ul class="dropdown-menu" role="menu">
							<li>
								<a href="<?=base_url()?>LangSwitch/switchLanguage/english" style="text-decoration: none; color: #00598c;">
									<img src="<?=base_url()?>assets/img/english_flag.png" style="border-radius:4px" /> &nbsp;&nbsp;English
								</a>
							</li>
							<li>
								<a href="<?=base_url()?>LangSwitch/switchLanguage/indonesia" style="text-decoration: none; color: #00598c;">
									<img src="<?=base_url()?>assets/img/indonesia_flag.png" style="border-radius:4px"/> &nbsp;&nbsp;Indonesia
								</a>
							</li>
						</ul>
					</li>
