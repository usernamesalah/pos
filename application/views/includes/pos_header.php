		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<ul class="user-menu">
					...
					<li class="dropdown pull-right" style="margin-right: 10px;">
						<a id="myLink" title="Click To Fullscreen" href="#" onclick="openFullscreen(); return false;" style="text-decoration: none;">
							<div style="background-color: #3fb618; color: #FFF; padding: 7px 6px; border-radius: 3px; margin-top: -5px;">
								&nbsp;Fullscreen
							</div>
						</a>
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<?php
                                ...
                                if ($temp_site_lang == 'english') {
                                    ...
                                    echo '<img src="'.base_url().'assets/img/indonesia_flag.png" />';
                                } else {
                                    echo '<img src="'.base_url().'assets/img/english_flag.png" />';
                                }
                            ?>
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li>
								<a href="<?=base_url()?>LangSwitch/switchLanguage/indonesia" style="text-decoration: none; color: #00598c;">
									<img src="<?=base_url()?>assets/img/indonesia_flag.png" /> &nbsp;&nbsp;Indonesia
								</a>
							</li>
						</ul>
					</li>
