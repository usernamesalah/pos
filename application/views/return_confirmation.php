			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-4">
							: <?php echo number_format($ret_paid_amt, 0,'.','.'); ?> (<?php echo $site_currency; ?>)
						</div>
						<div class="col-md-5"></div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							: <?php echo number_format($ret_taxTotal, 0,'.','.'); ?> (<?php echo $site_currency; ?>)
						</div>
						<div class="col-md-5"></div>
					</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							: <?php echo number_format($ret_grandTotal, 0,'.','.'); ?> (<?php echo $site_currency; ?>)
						</div>
						<div class="col-md-5"></div>
					</div>
